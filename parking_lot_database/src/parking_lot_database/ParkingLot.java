...
public class ParkingLot {
    private static final String ENTER_PARKING_LOT_INFO_SQL_FILE = "/sql/enter_parking_lot_info.sql";
    private static final String UPDATE_PARKING_LOT_INFO_SQL_FILE = "/sql/update_parking_lot_info.sql";
    private static final String DELETE_PARKING_LOT_INFO_SQL_FILE = "/sql/delete_parking_lot_info.sql";
